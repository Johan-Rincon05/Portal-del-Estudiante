-- Migración para actualizar roles según los nuevos requerimientos
-- Cambiar aliado_administrativo a aliado_comercial
-- Cambiar admin a SuperAdministrativos
...
VALUES ('0015_update_roles', NOW(), 'Actualización de roles: aliado_administrativo -> aliado_comercial, admin -> SuperAdministrativos, agregado permiso request:read a institucion_educativa'); 